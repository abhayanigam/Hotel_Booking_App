...
const RoomDetails = () => {
  ...
  return room &&  (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex flex-col md:flex-row md:justify-between mt-10'>
        ...
        {/* Check In check Out */}
      <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-2xl p-6 rounded-xl mx-auto mt-16 max-w-6xl]'>
  ...
  <div key={index} className='flex items-start gap-2'>
    ...
    <div className='max-w-3xl border-y border-gray-300 my-12 py-10 text-gray-500'>
      <p>Guests will be allocated on the ground floor according to availability. You get a comfortable two bedroom apartment has a true city feeling. The price quoted is for two guests, at the guest slot please mark the number of guests to get the exact price of groups. The guests will be allocated ground floor according to availablity . You get the comfortable two bedroom apartment that has a true city feeling.</p>
    </div>
